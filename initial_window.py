...
class NewWindow(QWidget):
    def __init__(self):
        ...
        self.mode_selector.addItems(["Tryb 1", "Tryb 2", "Tryb 3"])

        #pole na ścieżkę
        self.path_input = QLineEdit(self)
        self.path_input.setPlaceholderText("Wybierz ścieżkę zapisu")
    ...
    def select_save_path(self):
        ...
        options = QFileDialog.Options()
        file_path, _ = QFileDialog.getSaveFileName(self, "Wybierz ścieżkę zapisu", "", "Wszystkie pliki (*)",
                                                   options=options)
        if file_path:
